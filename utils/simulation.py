...
from parsers import parseReplay
...
def plot_hitmap(hitmap, beatmap, replay):
    import matplotlib.pyplot as plt
    res = len(hitmap)
    mods = replay['mods']
    csr = circle_radius(beatmap['cs'], mods['hard_rock'], mods['easy'])
...
def get_beatmap_id(bm_hash):
    ...
    key = '526c877ec9cfb4819406d44d3d64a0390f06532f'
...
if __name__ == '__main__':
    ...
    objects, beatmap, timingpoints = parse_osu(bm_file)
    ...
    plot_hitmap(results['hitmap'], beatmap, replay)
